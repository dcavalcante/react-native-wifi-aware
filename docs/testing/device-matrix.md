...
| Samsung SM-M515F (`RQ8NB08QJ1B`) | Android 12 / API 31 | supported | installed, launched, published, received, replied, and closed | Fresh two-device Stage 3 observation, 2026-08-24 |
| Samsung SM-X710 (`RX2W800461V`) | Android 16 / API 36 | supported | installed, launched, subscribed, discovered, sent, received, and closed | Fresh two-device Stage 3 observation, 2026-08-24 |
