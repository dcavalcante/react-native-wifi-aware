...
| 7 Apple network connection | provisional — compile and physical validation pending | Network framework publisher listener, subscriber connection, data-path lifecycle, and Apple-specific harness flow | Source implemented; lint/typecheck passed 2026-08-25. User deferred Codegen/package/Xcode/signing/two-device gates; no runtime claim. |
